	...
	<div class="head">
		<div class="head-con">
			<div class="head-nav">
				...
				<div class="head-text">商家登录 </div>
			</div>
		</div>
	</div>
	<form action="store/signin" method="post" >
		...
		<div class="body-surface">
			<div class="body-con">
				...
				<div class="body-signup">
					没有账号？<a href="view/store/storeregister.jsp">注册开店</a>
				</div>				
			</div>
		</div>
	</div>
...
<script charset="utf-8" type="text/javascript" src="js/store/storesignin.js"></script>
</html>