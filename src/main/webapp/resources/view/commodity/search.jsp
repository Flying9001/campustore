			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr style="height: 60px;">
					<td colspan="6" align="center">
						<a href="commodity/search?page.pagenum=0&page.limitnum=<s:property value="page.limitnum"/>&commodity.cname=<s:property value="commodity.cname"/>">
							[首页]</a> &nbsp;&nbsp;|&nbsp;&nbsp;
						<s:if test="page.pagenum > 0">
							<a href="commodity/search?page.pagenum=<s:property value="page.pagenum - 1"/>&page.limitnum=<s:property value="page.limitnum"/>&commodity.cname=<s:property value="commodity.cname"/>">
								[上一页]</a> &nbsp;&nbsp;|&nbsp;&nbsp;
						</s:if>
						...
						<a href="commodity/search?page.pagenum=<s:property value="#pagecount-1"/>&page.limitnum=<s:property value="page.limitnum"/>&commodity.cname=<s:property value="commodity.cname"/>">
							[末页]</a>
					</td>
				</tr>
				<tr style="height: 40px;">
